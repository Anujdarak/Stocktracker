  ...
  const getBiasBadge = (bias: string) => {
    ...
    if (b.includes('up') || b.includes('bull')) {
      ...
      return {
        ...
        icon: <Minus className="w-4 h-4 text-indigo-600" />,
    ...
    <div className="space-y-6 animate-in fade-in duration-300 max-w-6xl mx-auto">
      ...
      <div className="bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 text-white rounded-2xl p-6 sm:p-8 shadow-md border border-slate-800 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-300 text-sm mt-1 max-w-xl">
            Upload a screenshot of any stock or index chart with grounded NSE historical price data.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-5 bg-slate-900/90 rounded-2xl shadow-md border border-slate-800 p-6 space-y-5 hover-lift">
          ...
          <div className="relative">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="e.g. ZOMATO, RELIANCE, TITAN..."
            ...
            <p className="text-[11px] text-slate-400 mt-1">
              Grounds the pattern against real NSE historical price data.
            </p>
          </div>

          {/* Chart Screenshot Upload Zone */}
          <div>
            <label className="block text-xs font-bold uppercase tracking-wider text-slate-400 mb-1.5">
              Chart Screenshot
            </label>
          ...
          {/* Optional API Key Input for DeepSeek */}
          ...
          <button
            ...
            className={`w-full py-3 px-4 rounded-xl text-slate-950 font-bold text-sm flex items-center justify-center gap-2 transition-all shadow-md ${
          ...
          >
            {loading ? (
              <>
                ...
                Reading Pattern via {provider === 'deepseek' ? 'DeepSeek' : 'Gemini'}...
              </>
            ) : (
              <>
                <Sparkles size={16} />
                Generate Plain-Language Read
              </>
            )}
          </button>
        ...
        <div className="lg:col-span-7 flex flex-col gap-4">
          ...
          {result ? (
              ...
              <div className="p-6 bg-slate-950 border-b border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <h2 className="text-lg font-extrabold text-white">Analyst Pattern Readout</h2>
                  </div>
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="pt-2 border-t border-slate-800">
                  <button
                    ...
                    className="w-full py-2.5 px-3 text-xs font-bold text-slate-400 hover:text-white flex items-center justify-between rounded-lg hover:bg-slate-800/60 transition-colors"
                  >
                  ...
                  {showTechnicalDetails && (
                    <div className="mt-2 p-4 bg-slate-950 text-slate-200 rounded-xl space-y-2 text-xs font-mono border border-slate-800 animate-in fade-in duration-200">
                      ...
                      <div>• Technical Structure: <span className="text-amber-400">{result.trader_jargon?.technical_pattern || 'Consolidation zone'}</span></div>
                    </div>
                  )}
                </div>
            ...
            <div className="bg-slate-900/50 rounded-2xl border-2 border-dashed border-slate-800 p-12 flex flex-col items-center justify-center text-center space-y-3 min-h-[360px]">
              ...
              <h3 className="font-bold text-white text-base">Awaiting Chart Upload</h3>
